...
public class PlanMasaModerado extends PlanEjercicio {
    public PlanMasaModerado(Usuario usuario) {
        super("Moderado", "Aumentar Masa Muscular",usuario);
    }
            ...
            if (datos.getEdad() >= 10 && datos.getEdad() < 18) { // Hombres adolescentes (10-17 años)
                this.setEjercicios(new String[]{
                        "**Rutina Diaria para Hombres Adolescentes (60 min - Repetir 5 días a la semana)**\n" +
                                "   - **Calentamiento (5 minutos):** 3 minutos de cardio ligero (trotar, saltos de tijera) y 2 minutos de movilidad articular (círculos de hombros, caderas, tobillos).\n" +
                                "   - **Entrenamiento de Fuerza con Peso Corporal y Ligera Carga (50 minutos):** Realiza 3-4 series por ejercicio, con descansos de 60-90 segundos entre series. Enfócate en aprender la técnica.\n" +
                                "     1.  **Sentadillas (Squats) con peso corporal o mancuernas ligeras:** 4 series de 12-15 repeticiones.\n" +
                                "     2.  **Flexiones (Push-ups) en el suelo o elevadas (manos en banco):** 3 series de 10-15 repeticiones.\n" +
                                "     3.  **Remo invertido (Inverted Row) o Remo con banda:** 3 series de 10-15 repeticiones.\n" +
                                ...
                                "   - **Estiramiento (5 minutos):** Estiramientos estáticos de los principales grupos musculares trabajados (piernas, pecho, espalda, hombros, brazos)."
                });
            } else { // Hombres adultos (18+ años)
                this.setEjercicios(new String[]{
                        "**Rutina Diaria para Hombres Adultos (60 min - Repetir 5 días a la semana)**\n" +
                                "   - **Calentamiento (5 minutos):** 3 minutos de cardio moderado (elíptica, bicicleta) y 2 minutos de movilidad dinámica (círculos de hombros con poco peso, rotaciones de tronco).\n" +
                                "   - **Entrenamiento de Fuerza (50 minutos):** Realiza 3-4 series por ejercicio, buscando una **sobrecarga progresiva**. Descansa 60-90 segundos entre series.\n" +
            ...
            if (datos.getEdad() >= 10 && datos.getEdad() < 18) { // Mujeres adolescentes (10-17 años)
                this.setEjercicios(new String[]{
                        "**Rutina Diaria para Mujeres Adolescentes (60 min - Repetir 5 días a la semana)**\n" +
                                ...
                                "   - **Entrenamiento de Fuerza con Peso Corporal y Ligera Carga (50 minutos):** Realiza 3-4 series por ejercicio, con descansos de 60-90 segundos. Enfócate en la conexión mente-músculo.\n" +
                                "     1.  **Sentadillas Sumo con peso corporal o ligera mancuerna:** 4 series de 12-15 repeticiones.\n" +
                                "     2.  **Elevación de Cadera (Glute Bridge) con banda de resistencia:** 4 series de 15-20 repeticiones.\n" +
                ...
                this.setEjercicios(new String[]{
                        "**Rutina Diaria para Mujeres Adultas (60 min - Repetir 5 días a la semana)**\n" +
                                ...
                                "     5.  **Press de Hombros (Dumbbell Shoulder Press):** 3 series de 10-15 repeticiones.\n" +
                                "     6.  **Hip Thrust con Barra (Barbell Hip Thrust) o Elevación de Cadera con peso:** 3 series de 12-18 repeticiones.\n" +
